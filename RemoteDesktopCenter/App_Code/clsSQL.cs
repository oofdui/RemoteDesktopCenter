...
public class clsSQL
{
    ...
    public string getAppSettingServerName(string AppSettingName)
    {
        #region Variable
        var result = "";
        var connectionString = System.Configuration.ConfigurationManager.AppSettings[AppSettingName].Trim();
        string[] split1;
        #endregion
        #region ConnectionBuilder
        split1 = connectionString.Split(';');
        for (int i = 0; i < split1.Length; i++)
        {
            string[] split2 = split1[i].Split('=');
            if (split2[0].Trim().ToLower() == "server")
            {
                result = split2[1].Trim();
                break;
            }
        }
        #endregion
    ...
    public string getAppSettingDatabaseName(string AppSettingName)
    {
        #region Variable
        var result = "";
        var connectionString = System.Configuration.ConfigurationManager.AppSettings[AppSettingName].Trim();
        ...
        {
            string[] split2 = split1[i].Split('=');
            if (split2[0].Trim().ToLower() == "database")
            {
                result = split2[1].Trim();
                break;
            }
